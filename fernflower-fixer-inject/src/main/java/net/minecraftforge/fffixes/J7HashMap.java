    ...
    implements Map<K,V>, Cloneable, Serializable
{
     ...
     */
    public J7HashMap(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public J7HashMap(int initialCapacity) {
     ...
     */
    public J7HashMap(Map<? extends K, ? extends V> m) {
     ...
     */
    public Object clone() {
        J7HashMap<K,V> result = null;
            result = (J7HashMap<K,V>)super.clone();
        if (result.table != EMPTY_TABLE) {
            result.inflateTable(Math.min(
                (int) Math.min(
                    size * Math.min(1 / loadFactor, 4.0f),
                    // we have limits...
                    J7HashMap.MAXIMUM_CAPACITY),
               table.length));
        }
    ...
    private abstract class HashIterator<E> implements Iterator<E> {
        ...
        public void remove() {
            ...
            current = null;
            J7HashMap.this.removeEntryForKey(k);
            expectedModCount = modCount;
        }
    }
    ...
    private final class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            return J7HashMap.this.removeEntryForKey(o) != null;
        }
        public void clear() {
            J7HashMap.this.clear();
        }
    }
